...
| [`unet_buildings`](unet_buildings/)                                       | Semantic segmentation | U-Net (ResNet-34 encoder, PyTorch)   | ImageNet-pretrained encoder, full end-to-end finetuning              | `just example unet_buildings`                    |
